...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils llvm \
		icecatconfig-v6.60 pax-utils xdg-utils autotools icecatlinguas-v2
...
IUSE="eme-free geckodriver +gmp-autoupdate hardened hwaccel jack +screenshot selinux test -system-harfbuzz"

SDIR="release"
[[ ${PV} = *_beta* ]] && SDIR="beta"

PATCH_URI="https://dev.gentoo.org/~anarchy/mozilla/patchsets/firefox-60.6-patches-07.tar.xz"
SRC_URI="${SRC_URI}
	${MOZ_HTTP_URI}/${PV}/${PN}-${PV}-gnu1.tar.bz2
	${PATCH_URI}"
...
src_prepare() {
	eapply "${WORKDIR}"/firefox/2005_rust-1.33.0-missing-docs.patch
